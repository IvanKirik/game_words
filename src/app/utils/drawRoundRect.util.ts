export function drawRoundRect(ctx: CanvasRenderingContext2D, x: number, y: number, cellSize: number, cornerRadius: number, fillColor: string, text: string, textColor: string, fontSize: number): void {
    ...
    ctx.arcTo(x + cellSize, y + cellSize, x + cellSize - cornerRadius, y + cellSize, cornerRadius);
