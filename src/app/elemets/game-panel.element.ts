...
import {BACKGROUND_CIRCLE, CANVAS_WIDTH, LETTER_RADIUS, TOP_MARGIN_GAME_PANEL} from "../constants.ts";
...
export class GamePanelElement {
    ...
    constructor (ctx: CanvasRenderingContext2D, letters: string[], mouse: MouseService) {
    ...
    private createCircle() {
        drawCircleUtil(this.ctx, CANVAS_WIDTH / 2, TOP_MARGIN_GAME_PANEL, LETTER_RADIUS, BACKGROUND_CIRCLE, 20);
    }
